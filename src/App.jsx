...
const vocabData = [
  ...
  { char: 'あのひと', romaji: 'ano hito', meaning: 'ওই ব্যক্তি (he/she)', type: 'lesson01' },
  { char: 'あのかた', romaji: 'ano kata', meaning: 'ওই ভদ্র ব্যক্তি', type: 'lesson01' },

  { char: '～さん', romaji: '~san', meaning: 'জনাব / জনাবা (নামের পরে)', type: 'lesson01' },
  { char: '～ちゃん', romaji: '~chan', meaning: 'শিশু বা ঘনিষ্ঠ ডাকনাম', type: 'lesson01' },
  { char: '～じん', romaji: '~jin', meaning: 'দেশের নাগরিক (যেমন: アメリカじん)', type: 'lesson01' },

  { char: 'せんせい', romaji: 'sensei', meaning: 'শিক্ষক (নিজের জন্য ব্যবহার হয় না)', type: 'lesson01' },
  { char: 'きょうし', romaji: 'kyoushi', meaning: 'শিক্ষক', type: 'lesson01' },
  { char: 'がくせい', romaji: 'gakusei', meaning: 'ছাত্র / ছাত্রী', type: 'lesson01' },

  { char: 'かいしゃいん', romaji: 'kaishain', meaning: 'কোম্পানির কর্মচারী', type: 'lesson01' },
  { char: 'しゃいん', romaji: 'shain', meaning: 'কর্মচারী', type: 'lesson01' },

  { char: 'ぎんこういん', romaji: 'ginkouin', meaning: 'ব্যাংকের কর্মচারী', type: 'lesson01' },
  { char: 'いしゃ', romaji: 'isha', meaning: 'ডাক্তার', type: 'lesson01' },
  { char: 'けんきゅうしゃ', romaji: 'kenkyuusha', meaning: 'গবেষক', type: 'lesson01' },

  { char: 'だいがく', romaji: 'daigaku', meaning: 'বিশ্ববিদ্যালয়', type: 'lesson01' },
  { char: 'びょういん', romaji: 'byouin', meaning: 'হাসপাতাল', type: 'lesson01' },

  { char: 'だれ', romaji: 'dare', meaning: 'কে', type: 'lesson01' },
  { char: 'どなた', romaji: 'donata', meaning: 'কে (ভদ্র ভাষা)', type: 'lesson01' },

  { char: '～さい', romaji: '~sai', meaning: 'বছর বয়স', type: 'lesson01' },
  { char: 'なんさい', romaji: 'nansai', meaning: 'কত বছর বয়স', type: 'lesson01' },
  { char: 'おいくつ', romaji: 'oikutsu', meaning: 'কত বছর বয়স (ভদ্র)', type: 'lesson01' },

  { char: 'はい', romaji: 'hai', meaning: 'হ্যাঁ', type: 'lesson01' },
  { char: 'いいえ', romaji: 'iie', meaning: 'না', type: 'lesson01' },
  
  // --- Lesson 02 ---
  { char: 'これ', romaji: 'kore', meaning: 'এটি (এই জিনিস)', type: 'lesson02' },
  { char: 'それ', romaji: 'sore', meaning: 'ওটি (আপনার কাছে থাকা জিনিস)', type: 'lesson02' },
  { char: 'あれ', romaji: 'are', meaning: 'ওটা (ওখানে থাকা জিনিস)', type: 'lesson02' },

  { char: 'この～', romaji: 'kono ~', meaning: 'এই ~ (এখানে)', type: 'lesson02' },
  { char: 'その～', romaji: 'sono ~', meaning: 'ওই ~ (আপনার কাছে)', type: 'lesson02' },
  { char: 'あの～', romaji: 'ano ~', meaning: 'ওই ~ (ওখানে)', type: 'lesson02' },
  ...
  { char: 'てちょう', romaji: 'techou', meaning: 'ডায়েরি / ব্যক্তিগত নোটবই', type: 'lesson02' },
  { char: 'めいし', romaji: 'meishi', meaning: 'ভিজিটিং কার্ড', type: 'lesson02' },
  { char: 'カード', romaji: 'kaado', meaning: 'কার্ড (ক্রেডিট কার্ড)', type: 'lesson02' },

  { char: 'えんぴつ', romaji: 'enpitsu', meaning: 'পেন্সিল', type: 'lesson02' },
  { char: 'ボールペン', romaji: 'boorupen', meaning: 'বলপেন', type: 'lesson02' },
  { char: 'シャープペンシル', romaji: 'shaapu penshiru', meaning: 'মেকানিক্যাল পেন্সিল', type: 'lesson02' },

  { char: 'かぎ', romaji: 'kagi', meaning: 'চাবি', type: 'lesson02' },
  { char: 'とけい', romaji: 'tokei', meaning: 'ঘড়ি', type: 'lesson02' },
  { char: 'かさ', romaji: 'kasa', meaning: 'ছাতা', type: 'lesson02' },
  { char: 'かばん', romaji: 'kaban', meaning: 'ব্যাগ', type: 'lesson02' },

  { char: 'CD', romaji: 'shiidii', meaning: 'সিডি', type: 'lesson02' },

  { char: 'テレビ', romaji: 'terebi', meaning: 'টেলিভিশন', type: 'lesson02' },
  { char: 'ラジオ', romaji: 'rajio', meaning: 'রেডিও', type: 'lesson02' },
  { char: 'カメラ', romaji: 'kamera', meaning: 'ক্যামেরা', type: 'lesson02' },
  { char: 'コンピューター', romaji: 'konpyuutaa', meaning: 'কম্পিউটার', type: 'lesson02' },
  { char: 'くるま', romaji: 'kuruma', meaning: 'গাড়ি', type: 'lesson02' },

  { char: 'つくえ', romaji: 'tsukue', meaning: 'টেবিল / ডেস্ক', type: 'lesson02' },
  { char: 'いす', romaji: 'isu', meaning: 'চেয়ার', type: 'lesson02' },
  ...
  { char: 'そこ', romaji: 'soko', meaning: 'ওখানে (শ্রোতার কাছে)', type: 'lesson03' },
  { char: 'あそこ', romaji: 'asoko', meaning: 'ওখানে (দূরে)', type: 'lesson03' },
  { char: 'どこ', romaji: 'doko', meaning: 'কোথায়', type: 'lesson03' },

  { char: 'こちら', romaji: 'kochira', meaning: 'এই দিক / এখানে (ভদ্র)', type: 'lesson03' },
  { char: 'そちら', romaji: 'sochira', meaning: 'ওই দিক / ওখানে (ভদ্র)', type: 'lesson03' },
  { char: 'あちら', romaji: 'achira', meaning: 'ওই দিক / ওখানে (দূরে, ভদ্র)', type: 'lesson03' },
  { char: 'どちら', romaji: 'dochira', meaning: 'কোন দিক / কোথায় (ভদ্র)', type: 'lesson03' },

  { char: 'きょうしつ', romaji: 'kyoushitsu', meaning: 'ক্লাসরুম', type: 'lesson03' },
  { char: 'しょくどう', romaji: 'shokudou', meaning: 'ক্যান্টিন / ডাইনিং হল', type: 'lesson03' },
  { char: 'じむしょ', romaji: 'jimusho', meaning: 'অফিস', type: 'lesson03' },
  { char: 'かいぎしつ', romaji: 'kaigishitsu', meaning: 'মিটিং রুম', type: 'lesson03' },
  { char: 'うけつけ', romaji: 'uketsuke', meaning: 'রিসেপশন', type: 'lesson03' },
  { char: 'ロビー', romaji: 'robii', meaning: 'লবি', type: 'lesson03' },
  { char: 'へや', romaji: 'heya', meaning: 'রুম / ঘর', type: 'lesson03' },
  { char: 'トイレ', romaji: 'toire', meaning: 'টয়লেট', type: 'lesson03' },

  { char: 'かいだん', romaji: 'kaidan', meaning: 'সিঁড়ি', type: 'lesson03' },
  { char: 'エレベーター', romaji: 'erebeetaa', meaning: 'লিফট', type: 'lesson03' },
  { char: 'エスカレーター', romaji: 'esukareetaa', meaning: 'এস্কেলেটর', type: 'lesson03' },
  { char: 'じどうはんばいき', romaji: 'jidou hanbaiki', meaning: 'ভেন্ডিং মেশিন', type: 'lesson03' },

  { char: 'でんわ', romaji: 'denwa', meaning: 'টেলিফোন / ফোন কল', type: 'lesson03' },
  ...
  { char: 'ねます', romaji: 'nemasu', meaning: 'ঘুমানো / শুতে যাওয়া', type: 'lesson04' },
  { char: 'はたらきます', romaji: 'hatarakimasu', meaning: 'কাজ করা', type: 'lesson04' },
  { char: 'やすみます', romaji: 'yasumimasu', meaning: 'বিশ্রাম নেওয়া / ছুটি নেওয়া', type: 'lesson04' },
  { char: 'べんきょうします', romaji: 'benkyou shimasu', meaning: 'পড়াশোনা করা', type: 'lesson04' },
  { char: 'おわります', romaji: 'owarimasu', meaning: 'শেষ হওয়া', type: 'lesson04' },

  { char: 'デパート', romaji: 'depaato', meaning: 'ডিপার্টমেন্ট স্টোর', type: 'lesson04' },
  { char: 'ぎんこう', romaji: 'ginkou', meaning: 'ব্যাংক', type: 'lesson04' },
  { char: 'ゆうびんきょく', romaji: 'yuubinkyoku', meaning: 'ডাকঘর', type: 'lesson04' },
  { char: 'としょかん', romaji: 'toshokan', meaning: 'লাইব্রেরি', type: 'lesson04' },
  { char: 'びじゅつかん', romaji: 'bijutsukan', meaning: 'আর্ট মিউজিয়াম', type: 'lesson04' },

  { char: 'いま', romaji: 'ima', meaning: 'এখন', type: 'lesson04' },
  { char: '～じ', romaji: '~ji', meaning: 'টা (ঘণ্টা)', type: 'lesson04' },
  { char: '～ふん', romaji: '~fun', meaning: 'মিনিট', type: 'lesson04' },
  { char: 'はん', romaji: 'han', meaning: 'অর্ধেক', type: 'lesson04' },
  { char: 'なんじ', romaji: 'nanji', meaning: 'কয়টা বাজে', type: 'lesson04' },
  { char: 'なんぷん', romaji: 'nanpun', meaning: 'কয় মিনিট', type: 'lesson04' },

  { char: 'ごぜん', romaji: 'gozen', meaning: 'সকাল (a.m.)', type: 'lesson04' },
  { char: 'ごご', romaji: 'gogo', meaning: 'বিকাল (p.m.)', type: 'lesson04' },

  { char: 'あさ', romaji: 'asa', meaning: 'সকাল', type: 'lesson04' },
  { char: 'ひる', romaji: 'hiru', meaning: 'দুপুর', type: 'lesson04' },
  { char: 'ばん', romaji: 'ban', meaning: 'রাত', type: 'lesson04' },

  { char: 'おととい', romaji: 'ototoi', meaning: 'পরশু', type: 'lesson04' },
  { char: 'きのう', romaji: 'kinou', meaning: 'গতকাল', type: 'lesson04' },
  { char: 'きょう', romaji: 'kyou', meaning: 'আজ', type: 'lesson04' },
  { char: 'あした', romaji: 'ashita', meaning: 'আগামীকাল', type: 'lesson04' },
  { char: 'あさって', romaji: 'asatte', meaning: 'আগামী পরশু', type: 'lesson04' },

  { char: 'けさ', romaji: 'kesa', meaning: 'আজ সকাল', type: 'lesson04' },
  { char: 'こんばん', romaji: 'konban', meaning: 'আজ সন্ধ্যা / আজ রাত', type: 'lesson04' },

  { char: 'やすみ', romaji: 'yasumi', meaning: 'ছুটি / বিশ্রাম', type: 'lesson04' },
  { char: 'ひるやすみ', romaji: 'hiruyasumi', meaning: 'দুপুরের বিরতি', type: 'lesson04' },

  { char: 'しけん', romaji: 'shiken', meaning: 'পরীক্ষা', type: 'lesson04' },
  { char: 'かいぎ', romaji: 'kaigi', meaning: 'মিটিং', type: 'lesson04' },
  { char: 'えいが', romaji: 'eiga', meaning: 'সিনেমা', type: 'lesson04' },

  { char: 'まいあさ', romaji: 'maiasa', meaning: 'প্রতিদিন সকাল', type: 'lesson04' },
  { char: 'まいばん', romaji: 'maiban', meaning: 'প্রতিদিন রাত', type: 'lesson04' },
  { char: 'まいにち', romaji: 'mainichi', meaning: 'প্রতিদিন', type: 'lesson04' },

  { char: 'げつようび', romaji: 'getsuyoubi', meaning: 'সোমবার', type: 'lesson04' },
  { char: 'かようび', romaji: 'kayoubi', meaning: 'মঙ্গলবার', type: 'lesson04' },
  { char: 'すいようび', romaji: 'suiyoubi', meaning: 'বুধবার', type: 'lesson04' },
  { char: 'もくようび', romaji: 'mokuyoubi', meaning: 'বৃহস্পতিবার', type: 'lesson04' },
  { char: 'きんようび', romaji: 'kinyoubi', meaning: 'শুক্রবার', type: 'lesson04' },
  { char: 'どようび', romaji: 'doyoubi', meaning: 'শনিবার', type: 'lesson04' },
  { char: 'にちようび', romaji: 'nichiyoubi', meaning: 'রবিবার', type: 'lesson04' },
  { char: 'なんようび', romaji: 'nanyoubi', meaning: 'কোন বার', type: 'lesson04' },

  { char: '～から', romaji: '~kara', meaning: 'থেকে', type: 'lesson04' },
  { char: '～まで', romaji: '~made', meaning: 'পর্যন্ত', type: 'lesson04' },
  { char: '～と', romaji: '~to', meaning: 'এবং (noun যুক্ত করতে)', type: 'lesson04' },

  // --- Lesson 05 ---
  { char: 'いきます', romaji: 'ikimasu', meaning: 'যাওয়া', type: 'lesson05' },
  { char: 'きます', romaji: 'kimasu', meaning: 'আসা', type: 'lesson05' },
  { char: 'かえります', romaji: 'kaerimasu', meaning: 'ফিরে যাওয়া / বাড়ি ফেরা', type: 'lesson05' },

  { char: 'がっこう', romaji: 'gakkou', meaning: 'স্কুল', type: 'lesson05' },
  { char: 'スーパー', romaji: 'suupaa', meaning: 'সুপারমার্কেট', type: 'lesson05' },
  { char: 'えき', romaji: 'eki', meaning: 'স্টেশন', type: 'lesson05' },

  { char: 'ひこうき', romaji: 'hikouki', meaning: 'বিমান', type: 'lesson05' },
  { char: 'ふね', romaji: 'fune', meaning: 'জাহাজ', type: 'lesson05' },
  { char: 'でんしゃ', romaji: 'densha', meaning: 'ট্রেন', type: 'lesson05' },
  { char: 'ちかてつ', romaji: 'chikatetsu', meaning: 'আন্ডারগ্রাউন্ড / সাবওয়ে', type: 'lesson05' },
  { char: 'しんかんせん', romaji: 'shinkansen', meaning: 'বুলেট ট্রেন', type: 'lesson05' },
  { char: 'バス', romaji: 'basu', meaning: 'বাস', type: 'lesson05' },
  { char: 'タクシー', romaji: 'takushii', meaning: 'ট্যাক্সি', type: 'lesson05' },
  { char: 'じてんしゃ', romaji: 'jitensha', meaning: 'সাইকেল', type: 'lesson05' },
  { char: 'あるいて', romaji: 'aruite', meaning: 'হেঁটে', type: 'lesson05' },

  { char: 'ひと', romaji: 'hito', meaning: 'মানুষ', type: 'lesson05' },
  { char: 'ともだち', romaji: 'tomodachi', meaning: 'বন্ধু', type: 'lesson05' },
  { char: 'かれ', romaji: 'kare', meaning: 'সে (ছেলে)', type: 'lesson05' },
  { char: 'かのじょ', romaji: 'kanojo', meaning: 'সে (মেয়ে)', type: 'lesson05' },
  { char: 'かぞく', romaji: 'kazoku', meaning: 'পরিবার', type: 'lesson05' },
  { char: 'ひとりで', romaji: 'hitoride', meaning: 'একা', type: 'lesson05' },

  { char: 'せんしゅう', romaji: 'senshuu', meaning: 'গত সপ্তাহ', type: 'lesson05' },
  { char: 'こんしゅう', romaji: 'konshuu', meaning: 'এই সপ্তাহ', type: 'lesson05' },
  { char: 'らいしゅう', romaji: 'raishuu', meaning: 'আগামী সপ্তাহ', type: 'lesson05' },

  { char: 'せんげつ', romaji: 'sengetsu', meaning: 'গত মাস', type: 'lesson05' },
  { char: 'こんげつ', romaji: 'kongetsu', meaning: 'এই মাস', type: 'lesson05' },
  { char: 'らいげつ', romaji: 'raigetsu', meaning: 'আগামী মাস', type: 'lesson05' },

  { char: 'きょねん', romaji: 'kyonen', meaning: 'গত বছর', type: 'lesson05' },
  { char: 'ことし', romaji: 'kotoshi', meaning: 'এই বছর', type: 'lesson05' },
  { char: 'らいねん', romaji: 'rainen', meaning: 'আগামী বছর', type: 'lesson05' },

  { char: '～ねん', romaji: '~nen', meaning: '– বছর', type: 'lesson05' },
  { char: 'なんねん', romaji: 'nannen', meaning: 'কোন বছর', type: 'lesson05' },
  { char: '～がつ', romaji: '~gatsu', meaning: '– মাস', type: 'lesson05' },
  { char: 'なんがつ', romaji: 'nangatsu', meaning: 'কোন মাস', type: 'lesson05' },

  { char: 'ついたち', romaji: 'tsuitachi', meaning: '১ তারিখ', type: 'lesson05' },
  { char: 'ふつか', romaji: 'futsuka', meaning: '২ তারিখ', type: 'lesson05' },
  { char: 'みっか', romaji: 'mikka', meaning: '৩ তারিখ', type: 'lesson05' },
  { char: 'よっか', romaji: 'yokka', meaning: '৪ তারিখ', type: 'lesson05' },
  { char: 'いつか', romaji: 'itsuka', meaning: '৫ তারিখ', type: 'lesson05' },
  { char: 'むいか', romaji: 'muika', meaning: '৬ তারিখ', type: 'lesson05' },
  { char: 'なのか', romaji: 'nanoka', meaning: '৭ তারিখ', type: 'lesson05' },
  { char: 'ようか', romaji: 'youka', meaning: '৮ তারিখ', type: 'lesson05' },
  { char: 'ここのか', romaji: 'kokonoka', meaning: '৯ তারিখ', type: 'lesson05' },
  { char: 'とおか', romaji: 'tooka', meaning: '১০ তারিখ', type: 'lesson05' },
  { char: 'じゅうよっか', romaji: 'juuyokka', meaning: '১৪ তারিখ', type: 'lesson05' },
  { char: 'はつか', romaji: 'hatsuka', meaning: '২০ তারিখ', type: 'lesson05' },
  { char: 'にじゅうよっか', romaji: 'nijuu-yokka', meaning: '২৪ তারিখ', type: 'lesson05' },
  { char: '～にち', romaji: '~nichi', meaning: '– তারিখ', type: 'lesson05' },
  { char: 'なんにち', romaji: 'nannichi', meaning: 'কোন তারিখ / কত দিন', type: 'lesson05' },

  { char: 'いつ', romaji: 'itsu', meaning: 'কখন', type: 'lesson05' },
  { char: 'たんじょうび', romaji: 'tanjoubi', meaning: 'জন্মদিন', type: 'lesson05' },

  // --- Lesson 06 ---
  { char: 'たべます', romaji: 'tabemasu', meaning: 'খাওয়া', type: 'lesson06' },
  { char: 'のみます', romaji: 'nomimasu', meaning: 'পান করা', type: 'lesson06' },
  { char: 'すいます', romaji: 'suimasu', meaning: 'ধূমপান করা', type: 'lesson06' },
  { char: 'みます', romaji: 'mimasu', meaning: 'দেখা', type: 'lesson06' },
  { char: 'ききます', romaji: 'kikimasu', meaning: 'শোনা', type: 'lesson06' },
  { char: 'よみます', romaji: 'yomimasu', meaning: 'পড়া', type: 'lesson06' },
  { char: 'かきます', romaji: 'kakimasu', meaning: 'লেখা / আঁকা', type: 'lesson06' },
  { char: 'かいます', romaji: 'kaimasu', meaning: 'কেনা', type: 'lesson06' },
  { char: 'とります', romaji: 'torimasu', meaning: 'নেওয়া / ছবি তোলা', type: 'lesson06' },
  { char: 'します', romaji: 'shimasu', meaning: 'করা', type: 'lesson06' },
  { char: 'あいます', romaji: 'aimasu', meaning: 'দেখা করা / সাক্ষাৎ করা', type: 'lesson06' },

  { char: 'ごはん', romaji: 'gohan', meaning: 'ভাত / খাবার', type: 'lesson06' },
  { char: 'あさごはん', romaji: 'asagohan', meaning: 'নাশতা', type: 'lesson06' },
  { char: 'ひるごはん', romaji: 'hirugohan', meaning: 'দুপুরের খাবার', type: 'lesson06' },
  { char: 'ばんごはん', romaji: 'bangohan', meaning: 'রাতের খাবার', type: 'lesson06' },

  { char: 'パン', romaji: 'pan', meaning: 'পাউরুটি', type: 'lesson06' },
  { char: 'たまご', romaji: 'tamago', meaning: 'ডিম', type: 'lesson06' },
  { char: 'にく', romaji: 'niku', meaning: 'মাংস', type: 'lesson06' },
  { char: 'さかな', romaji: 'sakana', meaning: 'মাছ', type: 'lesson06' },
  { char: 'やさい', romaji: 'yasai', meaning: 'সবজি', type: 'lesson06' },
  { char: 'くだもの', romaji: 'kudamono', meaning: 'ফল', type: 'lesson06' },

  { char: 'みず', romaji: 'mizu', meaning: 'পানি', type: 'lesson06' },
  { char: 'おちゃ', romaji: 'ocha', meaning: 'চা / গ্রিন টি', type: 'lesson06' },
  { char: 'こうちゃ', romaji: 'koucha', meaning: 'লাল চা', type: 'lesson06' },
  { char: 'ぎゅうにゅう', romaji: 'gyuunyuu', meaning: 'দুধ', type: 'lesson06' },
  { char: 'ジュース', romaji: 'juusu', meaning: 'জুস', type: 'lesson06' },
  { char: 'ビール', romaji: 'biiru', meaning: 'বিয়ার', type: 'lesson06' },
  { char: 'おさけ', romaji: 'osake', meaning: 'মদ / জাপানি সাকে', type: 'lesson06' },
  { char: 'たばこ', romaji: 'tabako', meaning: 'সিগারেট', type: 'lesson06' },

  { char: 'てがみ', romaji: 'tegami', meaning: 'চিঠি', type: 'lesson06' },
  { char: 'レポート', romaji: 'repooto', meaning: 'রিপোর্ট', type: 'lesson06' },
  { char: 'しゃしん', romaji: 'shashin', meaning: 'ছবি', type: 'lesson06' },
  { char: 'ビデオ', romaji: 'bideo', meaning: 'ভিডিও', type: 'lesson06' },
  { char: 'みせ', romaji: 'mise', meaning: 'দোকান', type: 'lesson06' },
  { char: 'にわ', romaji: 'niwa', meaning: 'বাগান', type: 'lesson06' },

  { char: 'しゅくだい', romaji: 'shukudai', meaning: 'বাড়ির কাজ', type: 'lesson06' },
  { char: 'テニス', romaji: 'tenisu', meaning: 'টেনিস', type: 'lesson06' },
  { char: 'サッカー', romaji: 'sakkaa', meaning: 'ফুটবল', type: 'lesson06' },
  { char: 'おはなみ', romaji: 'ohanami', meaning: 'চেরি ফুল দেখা', type: 'lesson06' },

  { char: 'なに', romaji: 'nani', meaning: 'কি', type: 'lesson06' },
  { char: 'いっしょに', romaji: 'isshoni', meaning: 'একসাথে', type: 'lesson06' },
  { char: 'ちょっと', romaji: 'chotto', meaning: 'অল্প / একটু', type: 'lesson06' },
  { char: 'いつも', romaji: 'itsumo', meaning: 'সবসময়', type: 'lesson06' },
  { char: 'ときどき', romaji: 'tokidoki', meaning: 'মাঝে মাঝে', type: 'lesson06' },
  { char: 'それから', romaji: 'sorekara', meaning: 'তারপর', type: 'lesson06' },
  { char: 'ええ', romaji: 'ee', meaning: 'হ্যাঁ', type: 'lesson06' },
  { char: 'いいですね', romaji: 'ii desu ne', meaning: 'ভালো তো!', type: 'lesson06' },
  { char: 'わかりました', romaji: 'wakarimashita', meaning: 'বুঝেছি', type: 'lesson06' },

  // --- Lesson 07 --- 
  { char: 'きります', romaji: 'kirimasu', meaning: 'কাটা / স্লাইস করা', type: 'lesson07' },
  { char: 'おくります', romaji: 'okurimasu', meaning: 'পাঠানো', type: 'lesson07' },
  { char: 'あげます', romaji: 'agemasu', meaning: 'দেওয়া', type: 'lesson07' },
  { char: 'もらいます', romaji: 'moraimasu', meaning: 'নেওয়া / পাওয়া', type: 'lesson07' },
  { char: 'かします', romaji: 'kashimasu', meaning: 'ধার দেওয়া', type: 'lesson07' },
  { char: 'かります', romaji: 'karimasu', meaning: 'ধার নেওয়া', type: 'lesson07' },
  { char: 'おしえます', romaji: 'oshiemasu', meaning: 'শেখানো', type: 'lesson07' },
  { char: 'ならいます', romaji: 'naraimasu', meaning: 'শেখা', type: 'lesson07' },
  { char: 'かけます', romaji: 'kakemasu', meaning: 'ফোন করা', type: 'lesson07' },

  { char: 'て', romaji: 'te', meaning: 'হাত', type: 'lesson07' },
  { char: 'はし', romaji: 'hashi', meaning: 'চপস্টিক', type: 'lesson07' },
  { char: 'スプーン', romaji: 'supuun', meaning: 'চামচ', type: 'lesson07' },
  { char: 'ナイフ', romaji: 'naifu', meaning: 'ছুরি', type: 'lesson07' },
  { char: 'フォーク', romaji: 'fooku', meaning: 'কাঁটা চামচ', type: 'lesson07' },
  { char: 'はさみ', romaji: 'hasami', meaning: 'কাঁচি', type: 'lesson07' },

  { char: 'パソコン', romaji: 'pasokon', meaning: 'কম্পিউটার', type: 'lesson07' },
  { char: 'ケータイ', romaji: 'keetai', meaning: 'মোবাইল ফোন', type: 'lesson07' },
  { char: 'メール', romaji: 'meeru', meaning: 'ই-মেইল', type: 'lesson07' },
  { char: 'ねんがじょう', romaji: 'nengajou', meaning: 'নববর্ষের শুভেচ্ছা কার্ড', type: 'lesson07' },
  { char: 'パンチ', romaji: 'panchi', meaning: 'পাঞ্চ (কাগজ ছিদ্রকারী)', type: 'lesson07' },
  { char: 'ホッチキス', romaji: 'hotchikisu', meaning: 'স্ট্যাপলার', type: 'lesson07' },
  { char: 'セロテープ', romaji: 'seroteepu', meaning: 'টেপ', type: 'lesson07' },
  { char: 'けしゴム', romaji: 'keshigomu', meaning: 'রাবার / ইরেজার', type: 'lesson07' },
  { char: 'かみ', romaji: 'kami', meaning: 'কাগজ', type: 'lesson07' },

  { char: 'はな', romaji: 'hana', meaning: 'ফুল', type: 'lesson07' },
  { char: 'シャツ', romaji: 'shatsu', meaning: 'শার্ট', type: 'lesson07' },
  { char: 'プレゼント', romaji: 'purezento', meaning: 'উপহার', type: 'lesson07' },
  { char: 'にもつ', romaji: 'nimotsu', meaning: 'লাগেজ / মালপত্র', type: 'lesson07' },
  { char: 'おかね', romaji: 'okane', meaning: 'টাকা', type: 'lesson07' },
  { char: 'きっぷ', romaji: 'kippu', meaning: 'টিকিট', type: 'lesson07' },
  { char: 'クリスマス', romaji: 'kurisumasu', meaning: 'ক্রিসমাস', type: 'lesson07' },

  { char: 'ちち', romaji: 'chichi', meaning: '(আমার) বাবা', type: 'lesson07' },
  { char: 'はは', romaji: 'haha', meaning: '(আমার) মা', type: 'lesson07' },
  { char: 'おとうさん', romaji: 'otousan', meaning: '(অন্যের / সম্মানসূচক) বাবা', type: 'lesson07' },
  { char: 'おかあさん', romaji: 'okaasan', meaning: '(অন্যের / সম্মানসূচক) মা', type: 'lesson07' },
